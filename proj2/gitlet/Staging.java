...
/** data structure for staging area to store the to be added files,
 * to be removed files and to be tracked file
...
public class Staging implements Serializable {
    /** storing staged files to be modified or added,
     * runtime constriction, choose hashMap or treeMap */
    ...
    /** cached files from previous commit; facilitates add()
     * when file is modified, then changed back to
