...
public class Commit implements Serializable {
    ...
    public Commit() {
        //has to instantiate in sequence, cannot instantiate parent after id = generateID.
    ...
    /** Utils.sha1 only takes String or bytes. So we need to convert curr-Time to String. */
